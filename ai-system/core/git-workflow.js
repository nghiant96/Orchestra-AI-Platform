 ...
 * a short run ID.
 */
export function generateSafeBranchName(task, runId, externalTask, options = {}) {
 ...
 */
export async function isRepoDirty(repoRoot) {
 ...
 */
export async function createGitBranch(repoRoot, branchName) {
    const { runCommand } = await import("../utils/api.js");
    await runCommand({
        command: "git",
 ...
 * Stages files in git.
 */
export async function stageGitFiles(repoRoot, filePaths) {
 ...
 */
export function generateCommitMessage(task, appliedFiles, externalTask, options = {}) {
    let subject;
    if (externalTask) {
 ...
 */
export function generatePRDescription(task, appliedFiles, runResult, externalTask) {
    const sections = [];
    // Summary section
 ...
 */
export function generatePRPreview(branchName, task, appliedFiles, runResult, externalTask) {
