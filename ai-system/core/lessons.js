...
export async function readProjectLessons(repoRoot, limit = 10) {
...
export async function appendProjectLesson(repoRoot, lesson) {
    const lessonsPath = resolveLessonsPath(repoRoot);
...
export function proposeLessonsFromRuns(runs) {
...
function resolveLessonsPath(repoRoot) {
