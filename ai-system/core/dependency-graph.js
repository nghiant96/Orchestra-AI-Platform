...
export class DependencyGraph {
    ...
    async getRelatedFiles(entryFiles, maxDepth = 1) {
        const related = new Set(entryFiles);
    ...
    async getOrAddNode(relativePath) {
    ...
    async parseImports(relativePath) {
    ...
    async resolveImport(sourceFile, importPath) {
