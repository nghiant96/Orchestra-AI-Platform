...
import { printDoctor, printConfigShow, printConfigUseResult, printSetupCheck, outputJsonResult } from "../formatters.js";
export async function handleConfigCommand(command, options) {
    const { cwd, configPath, globalConfig, explicitGlobalConfigPath, ignoreProjectConfig, outputJson, savePath } = options;
    switch (command.kind) {
        case "doctor": {
