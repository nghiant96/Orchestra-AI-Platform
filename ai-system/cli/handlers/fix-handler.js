...
import { printFixChecksPreparation, printFixFromRunPreparation, printRetryResult, printResult, outputJsonResult } from "../formatters.js";
import { runTask } from "./task-handler.js";
export async function handleFixCommand(command, options) {
    const { cwd, dryRun, interactive, pauseAfterPlan, pauseAfterGenerate, configPath, providerPreset, retryStage, outputJson, savePath, force } = options;
    switch (command.kind) {
        case "fix-checks": {
