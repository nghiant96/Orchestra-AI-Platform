 ...
 */
export function printWorkItem(workItem) {
    console.log("");
 ...
 */
export function printWorkItemList(workItems) {
    console.log("");
    ...
    for (const item of workItems) {
        console.log(`- ${item.id}: status=${item.status}, risk=${item.risk}, title=${item.title}`);
    }
    console.log("");
}
