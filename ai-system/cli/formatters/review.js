...
export function printCurrentChangeReviewResult(result) {
    console.log("");
...
export function printFailingChecksReviewResult(result) {
    console.log("");
...
export function printRoutingExplanation({ source, repoRoot, task, planning, implementation }) {
    console.log("");
    console.log("Routing");
...
export function printRoutingStage(label, decision) {
    console.log(`- ${label}:`);
    console.log(`  - enabled: ${decision.enabled}`);
    console.log(`  - profile: ${decision.profile}`);
    console.log(`  - reason: ${decision.reason}`);
    console.log(`  - role providers: planner=${decision.roleProviders.planner}, reviewer=${decision.roleProviders.reviewer}, generator=${decision.roleProviders.generator}, fixer=${decision.roleProviders.fixer}`);
    if (Object.keys(decision.appliedRoles ?? {}).length > 0) {
        console.log(`  - applied roles: ${Object.entries(decision.appliedRoles)
