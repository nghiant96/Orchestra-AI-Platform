...
export const fastFixWorkflowProfile: WorkflowProfile = {
  id: "fast-fix",
  label: "Fast Fix",
...
export const balancedWorkflowProfile: WorkflowProfile = {
  id: "balanced",
  label: "Balanced",
...
export const strictReviewWorkflowProfile: WorkflowProfile = {
  id: "strict-review",
  label: "Strict Review",
