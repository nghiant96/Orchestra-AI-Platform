...
import { rankContextCandidates, trimRankedCandidatesByBudget } from "../ai-system/core/context-intelligence.js";
describe("Context Intelligence Core", () => {
    ...
    it("rankContextCandidates assigns correct scores to files", () => {
        ...
        const getScore = (path) => candidates.find((c) => c.path === path)?.score;
