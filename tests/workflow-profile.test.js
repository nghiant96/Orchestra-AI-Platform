...
import { applyWorkflowProfileToTask, buildWorkflowEvidenceChecklist, parseWorkflowProfileId, tightenApprovalPolicyForProfile } from "../ai-system/workflows/workflow-registry.js";
describe("workflow profiles", () => {
    test("superpowers tightens but does not weaken approval policy", () => {
        const base = resolveApprovalPolicy("touch a docs file", { skip_approval: true });
