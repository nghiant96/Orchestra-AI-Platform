...
import { listWorkItems, createWorkItem, getWorkItem, getWorkItemEvents, runWorkItem, normalizeWorkItemInput, normalizeWorkItemType, normalizeWorkItemSource, normalizeExpectedOutput } from "../ai-system/work/work-item-service.js";
describe("WorkItemService", () => {
    ...
    test.before(async () => {
        ...
        queue = new FileBackedJobQueue(resolveJobQueueDirectory(tmpDir), async () => ({}));
    ...
    const ctx = () => ({
        ...
        rules: { artifacts: { data_dir: ".test-artifacts" } }
    });
    ...
    test("getWorkItemEvents returns timeline entries for linked jobs and audits", async () => {
        ...
        const store = new WorkStore(tmpDir, { artifacts: { data_dir: ".ai-system-artifacts" } });
