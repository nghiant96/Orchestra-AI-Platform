...
import { generateSafeBranchName, generateCommitMessage, generatePRDescription, generatePRPreview } from "../ai-system/core/git-workflow.js";
...
test("generatePRPreview generates a valid preview object", () => {
    ...
    assert.strictEqual(preview.payload.head, "feat-branch");
