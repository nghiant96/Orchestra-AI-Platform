...
import { appendProjectLesson, formatLessonsForPrompt, proposeLessonsFromRuns, readProjectLessons } from "../ai-system/core/lessons.js";
...
function failedRun(failureClass) {
    return {
        runState: {
            status: "failed",
