...
### 1. README quá dài, làm người mới dễ “ngợp”

README hiện chứa rất nhiều thứ: quick start, CLI commands, routing, tool checks, vector search, Docker, server API, env vars, notes. Nó đầy đủ nhưng hơi giống “internal manual”.

Vấn đề: người dùng mới cần hiểu trong 30 giây:

> Orchestra giúp tôi làm gì tốt hơn Claude Code / Codex CLI / Gemini CLI?

Hiện câu trả lời có, nhưng bị chìm trong quá nhiều chi tiết.

Mình sẽ tách README thành:

* README ngắn: pitch + quickstart + demo
* `docs/CLI.md`
* `docs/SERVER.md`
* `docs/CONFIG.md`
